...
export const PROGRAMME_DAYS: ProgrammeDay[] = [
  {
    ...
    schedule: [
      ...
      { time: "2:30 PM", activity: "Opening & Programme Overview" },
      { time: "3:00 PM", activity: "The Contractor Mindset — Thinking Like a Business Owner" },
      { time: "4:15 PM", activity: "Understanding Industry Expectations & Standards" },
      { time: "5:00 PM", activity: "Refreshment Break", kind: "break" },
      { time: "5:30 PM", activity: "Building a Professional Corporate Profile" },
      { time: "6:45 PM", activity: "Break & Maghrib", kind: "break" },
      { time: "8:00 PM", activity: "Dinner", kind: "meal" },
      { time: "8:45 PM", activity: "Crafting a Strong Capability Statement" },
      { time: "9:30 PM", activity: "Building Business Credibility & Reputation" },
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "8:30 AM", activity: "Project Management Essentials for Contractors" },
      { time: "10:00 AM", activity: "Refreshment Break", kind: "break" },
      { time: "10:30 AM", activity: "Tender Readiness — Qualifying & Preparing to Bid" },
      { time: "12:30 PM", activity: "Lunch & Zohor Break", kind: "meal" },
      { time: "2:00 PM", activity: "Proposal Excellence — Writing Winning Submissions" },
      { time: "3:30 PM", activity: "Refreshment Break", kind: "break" },
      { time: "4:00 PM", activity: "Client Engagement & Relationship Building" },
      { time: "5:30 PM", activity: "Break & Maghrib", kind: "break" },
      { time: "8:00 PM", activity: "Dinner", kind: "meal" },
      { time: "8:45 PM", activity: "Business Presentation Skills Workshop" },
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "8:15 AM", activity: "AI for Contractors — Practical Foundations" },
      { time: "9:15 AM", activity: "Business Automation & Productivity Tools" },
      { time: "10:00 AM", activity: "Refreshment Break", kind: "break" },
      { time: "10:15 AM", activity: "AI-Assisted Proposal Writing (Hands-On)" },
      { time: "10:45 AM", activity: "Digital Marketing for Contractors" },
      { time: "11:15 AM", activity: "Building Your 90-Day Business Action Plan" },
